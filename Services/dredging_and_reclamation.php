...
<head>
    ...
    <title>Dredging and Reclamation - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h4 id="banner-heading">Dredging and Reclamation</h4>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Dredging And Reclamation</h1>
                    </div>
                    <article>
                        <p>
                            We offer dredging and reclamation services, shoreline protection and the leasing of dredging equipment.
                        </p>
                    </article>
                </div>
            </div>
