...
<head>
    ...
    <title>Logging Unit Tools Maintenance and Repair - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h4 id="banner-heading">Logging Unit Tools Maintenance and Repair</h4>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Logging Unit Tools Maintenance And Repair</h1>
                    </div>
                    <article>
                        <p>
                            We offer services of maintenance, repair, upgrade/modification and overhaul of logging tools, logging units and accessories. Examples are skid units, logging trucks, surface panels, down hole monitoring and inspection systems, logging tools, wireline services, etc. 
                        </p>
                    </article>
                </div>
            </div>
