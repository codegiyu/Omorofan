...
<head>
    ...
    <title>Storage Vessels Installation and Maintenance</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h4 id="banner-heading">Storage Vessels Installation and Maintenance</h4>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Storage Vessels Installation And Maintenance</h1>
                    </div>
                    <article>
                        <p>
                            Installation, refurbishing and maintenance of tank farms, storage vessels and systems both offshore and onshore etc.
                        </p>
                    </article>
                </div>
            </div>
