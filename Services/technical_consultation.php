...
<head>
    ...
    <title>Technical Consultation - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h4 id="banner-heading">Technical Consultation</h4>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Technical Consultation</h1>
                    </div>
                    <article>
                        <p>
