...
<head>
    ...
    <title>Warehouse Erection - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h4 id="banner-heading">Warehouse Erection</h4>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Warehouse Erection</h1>
                    </div>
                    <article>
                        <p>
                            We offer erection of warehouses, refurbishing and aluminum installations including but not limited to aluminum sheets.
                        </p>
                    </article>
                </div>
            </div>
