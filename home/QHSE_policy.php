...
<head>
    ...
    <title>QHSE Policy - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">QHSE Policy</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-star" aria-hidden="true"></i> QHSE Policy</h1>
                    </div>
                    <article>
                        <p>
                            Omorofan EMT Ltd is committed to the provision of a safe working environment for all our employees, subcontractors, local communities and others affected (either directly or indirectly) by our operation in accordance with industry regulations, HSE policies, federal statutory regulations and international best practices. 
                        </p>
                        <p>
                            We have set stringent standard for global-best safety practices, both at project worksites and in our office environments. 
                        </p>
                        <p>
                            And to support these standards, we are committed to offer refresher trainings as well as safety evaluation programs at regular intervals. These programs and standards will continue to improve project performance through heightened employee awareness, reduced schedule disruptions due to lost time incidents and accidents and minimized liability claims.
                        </p>
                    </article>
                </div>
            </div>
