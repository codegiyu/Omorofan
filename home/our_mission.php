...
<head>
    ...
    <title>Our Mission - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">Our Mission</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Our Mission</h1>
                    </div>
                    <article>
                        <ul class="content-list">
                            <li>
                                <p>
                                    To continuously deliver the most reliable quality products and services in Nigeria and beyond, in a way that we do not hurt people or the environment. 
                                </p>
                            </li>
                            <li>
                                <p>
                                    To remain the best choice in maintenance and engineering services across the industries in Nigeria.
                                </p>
                            </li>
                        </ul>
                    </article>
