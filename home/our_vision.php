...
<head>
    ...
    <title>Our Vision - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">Our Vision</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Our Vision</h1>
                    </div>
                    <article>
                        <ul class="content-list">
                            <li>
                                <p>
                                    To be the leading indigenous maintenance and service company in oil and gas, healthcare and other industrial sectors, that delivers reliable and cost-effective services to our clients in Nigeria and beyond. 
                                </p>
                            </li>
                            <li>
                                <p>
                                    To provide reliable technologies and products that will make OMOROFAN the company of choice in providing engineering solutions in Nigeria.
                                </p>
                            </li>
                        </ul>
                    </article>
