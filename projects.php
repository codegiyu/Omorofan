            ...
            <div class="nav-block">
                <ul>
                    <li class="nav-block-header">
                        <a href="projects.php"><i class="fa fa-bars" aria-hidden="true"></i> Projects</a>
                    </li>
                    <li>
                        <a href="projects/field_operation_intervention.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Field Operation Intervention at Well Site</a>
                    </li>
                    <li>
                        <a href="projects/C-Arm_troubleshooting_and_repair.php"><i class="fa fa-caret-right" aria-hidden="true"></i> C-Arm Troubleshooting and Repair</a>
                    </li>
                    <li>
                        <a href="projects/DC_MOT_troubleshooting_and_repair.php"><i class="fa fa-caret-right" aria-hidden="true"></i> D.C. M.O.T. Troubleshooting and Repair</a>
                    </li>
                </ul>
            </div>
