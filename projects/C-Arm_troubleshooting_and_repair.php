...
<head>
    ...
    <title>C-Arm Troubleshooting And Repair - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">C-ARM Troubleshooting And Repair</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> C-Arm Troubleshooting and Repair</h1>
                    </div>
                    <div class="gallery-wrap">
                        <div class="mySlides">
                            <div class="numbertext">1 / 2</div>
                            <img src="../img/C-Arm test.PNG" style="">
                        </div>
                        
                        <div class="mySlides">
                            <div class="numbertext">2 / 2</div>
                            <img src="../img/C-Arm.PNG" style="">
                        </div>
                        
                        <!-- <div class="mySlides">
                            <div class="numbertext">3 / 4</div>
                            <img src="../img/photo37.jpeg" style="">
                        </div>
                        
                        <div class="mySlides">
                            <div class="numbertext">4 / 4</div>
                            <img src="../img/photo39.jpeg" style="">
                        </div> -->
                        
                        <!-- <div class="mySlides">
                            <div class="numbertext">5 / 6</div>
                            <img src="img_nature_wide.jpg" style="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="../img/C-Arm test.PNG" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="../img/C-Arm.PNG" style="width:100%" onclick="currentSlide(2)" alt="">
                            </div>
                            <!-- <div class="column">
