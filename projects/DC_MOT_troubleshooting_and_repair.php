...
<head>
    ...
    <link rel="stylesheet" href="css/projectitemstyle.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700;800;900&display=swap');
        @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&display=swap');
    </style>
    <title>D.C. M.O.T Troubleshooting And Repair - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">D.C. M.O.T. Troubleshooting And Repair</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> D.C. M.O.T. Troubleshooting And Repair</h1>
                    </div>
                    <div class="gallery-wrap">
                        <div class="mySlides">
                            <div class="numbertext">1 / 2</div>
                            <img src="../img/DC_MOT-01-02.jpeg" style="">
                        </div>
                        
                        <div class="mySlides">
                            <div class="numbertext">2 / 2</div>
                            <img src="../img/photo72.jpg" style="">
                        </div>
                        
                        <!-- <div class="mySlides">
                            <div class="numbertext">3 / 4</div>
                            <img src="../img/photo37.jpeg" style="width:100%">
                        </div>
                        
                        <div class="mySlides">
                            <div class="numbertext">4 / 4</div>
                            <img src="../img/photo39.jpeg" style="width:100%">
                        </div> -->
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="../img/DC_MOT-01-02.jpeg" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="../img/photo72.jpg" style="width:100%" onclick="currentSlide(2)" alt="">
                            </div>
                            <!-- <div class="column">
                                <img class="demo cursor" src="../img/photo37.jpeg" style="width:100%" onclick="currentSlide(3)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="../img/photo39.jpeg" style="width:100%" onclick="currentSlide(4)" alt="">
                            </div> -->
                            <!-- <div class="column">
