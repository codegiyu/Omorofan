...
<head>
    ...
    <title>Field Operation Intervention - Omorofan EMT Nig Ltd</title>
</head>
<body>
    ...
    <section class="container" id="banner-section">
        <div class="jumbotron" id="intro-header">
            <h2 id="banner-heading">Field Operation Intervention At Well Site</h2>
        </div>
    </section>
            ...
            <div class="main-block">
                <div class="content">
                    <div class="content-header">
                        <h1><i class="fa fa-caret-right" aria-hidden="true"></i> Field Operation Intervention At Well Site</h1>
                    </div>
                    <div class="gallery-wrap">
                        <div class="mySlides">
                            <div class="numbertext">1 / 4</div>
                            <img src="../img/photo17.jpeg" style="">
                        </div>
                        
                        <div class="mySlides">
                            <div class="numbertext">2 / 4</div>
                            <img src="../img/photo38.jpeg" style="">
                        </div>
                        ...
                        <div class="row">
                            <div class="column">
                                <img class="demo cursor" src="../img/photo17.jpeg" style="width:100%" onclick="currentSlide(1)" alt="">
                            </div>
                            <div class="column">
                                <img class="demo cursor" src="../img/photo38.jpeg" style="width:100%" onclick="currentSlide(2)" alt="">
                            </div>
                            <div class="column">
